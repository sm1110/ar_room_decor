...
import 'package:ar_room_decor/api_consumer.dart';
  ...
  saveItemInfoToFirestore()
  {
    ...
    FirebaseFirestore.instance
        ...
        .set(
        {
          ...
          "sellePhone": sellerPhoneTextEditingController.text,
          "itemPrice": itemPriceTextEditingController.text,
          "publishedDate": DateTime.now(),
          "status": "available",
        });
    Fluttertoast.showToast(msg: " your new items uploaded successfully.");
    setState(() {
      isUploading= false;
